...
module.exports = [
    {
        ...
        handler: async (request, h) => {
            ...
            try {
                await mailService.sendMail(request.payload.email, `Bienvenu(e) ${request.payload.firstName} ${request.payload.lastName}`,
                `Bienvenu(e) ${request.payload.firstName} ${request.payload.lastName},\n\n Vous venez de vous inscrire sur notre plateforme.`)
            } catch (err) {
                console.log(err)
            }
